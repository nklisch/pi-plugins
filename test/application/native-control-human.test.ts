...
describe("native control human fields", () => {
  it("returns only prevalidated safe fields and never machine JSON", () => {
    const envelope = createNativeControlEnvelope({ executionId: "native-control-execution-v1:123e4567-e89b-42d3-a456-426614174000" as never, command: "status", status: "ok", data: { secretMachineCanary: "not-rendered" }, human: [{ text: "Host ready", escaped: false, truncated: false }] });
