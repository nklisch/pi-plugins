...
import { createFilesystemMarketplacePathAcquirer, createSecureContentWriterFactory } from "../filesystem/secure-content-writer.js";
...
export function createNodeSourceMaterializers(
  ...
  return createSourceMaterializers({
    git,
    npm,
    content,
    sha256,
