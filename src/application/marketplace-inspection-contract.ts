...
export type MarketplaceCatalogMerger = (inputs: readonly [{ nativeHost: "claude" | "codex"; result: MarketplaceReadResult }, ...{ nativeHost: "claude" | "codex"; result: MarketplaceReadResult }[]]) => MarketplaceReadResult;
