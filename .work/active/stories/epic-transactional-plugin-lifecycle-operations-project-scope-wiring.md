...
- [ ] Project install, enable, and update succeed with valid project trust/root authority and cooperating ports.
- [ ] Missing/untrusted project authority fails closed with the existing safe rejection semantics.
- [ ] User scope does not call project-root authority.
- [ ] End-to-end service coverage includes skill, hook, and MCP projection content plus user/project isolation.
- [ ] Existing transaction, rollback, and recovery-required tests remain green.
