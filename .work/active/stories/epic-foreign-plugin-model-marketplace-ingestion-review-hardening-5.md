...
- [ ] Derived plugin-root paths carry complete root-plus-entry provenance in Claude and Codex readers.
- [ ] Same-location conflicting raw declarations cannot disappear silently; exact duplicates still deduplicate.
- [ ] Provenance ordering remains deterministic across input permutations.
